                            ...
                            <div class="image_wrapper">
                                ...
                                <div class="carousel-caption justify-content-center">
                                    <div class="col-10 align-center">
                                        <h2 class="mbr-fonts-style display-1">{{ $slide2->title }}</h2>
                                        <p class="lead mbr-text mbr-fonts-style display-5">{!! $slide2->content !!}
                                        </p>
                <div class="mbr-section-btn" buttons="0"><a class="btn btn-success display-4" href="/aboutcliq">Connect</a> <a class="btn  btn-white-outline display-4" href="/contact">Contact</a></div>
            </div></div></div></div></div>
                                ...
                                <div class="image_wrapper">
                                    ...
                                    <div class="carousel-caption justify-content-center">
                                        <div class="col-10 align-left">
                                            <h2 class="mbr-fonts-style display-1">{{ $slide3->title }}</h2>
                                            <p class="lead mbr-text mbr-fonts-style display-5">{{ $slide3->content }}</p>  
                                            <div class="mbr-section-btn" buttons="0"><a class="btn btn-success display-4" href="/aboutcliq">Connect</a> <a class="btn  btn-white-outline display-4" href="/contact">Contact</a></div>
                                        </div>
                                    </div>
                                </div>
...
<!--  End Of the First Slider -->            
        ...
        <a data-app-prevent-settings="" class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#slider1-w"><span aria-hidden="true" class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a><a data-app-prevent-settings="" class="carousel-control carousel-control-next" role="button" data-slide="next" href="#slider1-w"><span aria-hidden="true" class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a>
    </div></div>
