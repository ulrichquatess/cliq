		...
		<div id="titleBar" class="container-fluid">
			<div class="row">
				<div id="pageTabTitle" class="headerBlock col-md-2">
					<h4>{{ $page20->title_fr }}</h4>
				</div>
				<div id="pageTitle" class="headerBlock col-md-10">
					<h3><span class="yellow">{{ $page20->sub_title_fr }}</span></h3>
				</div>
			</div>
		</div>			
	</header>
		...
		<div class="container" class="pageContent">
			<div class="row well">
				<div class="ulrich col-md-8">
					<p>{!! $page20->content_fr !!}</p>
					<h1 class="text-sblue fw7">{{ $page20->option_fr }}</h1>
				</div>
				<div class="col-md-4">
